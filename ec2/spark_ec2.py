...
def launch_cluster(conn, opts, cluster_name):
  ...
  if master_group.rules == []: # Group was just now created
    ...
    master_group.authorize('tcp', 8000, 8088, '0.0.0.0/0')
  ...
  if slave_group.rules == []: # Group was just now created
    ...
    slave_group.authorize('tcp', 8000, 8088, '0.0.0.0/0')
...
def setup_cluster(conn, master_nodes, slave_nodes, opts, deploy_ssh_key):
  ...
  modules = ['tachyon', 'spark', 'ephemeral-hdfs', 'persistent-hdfs',
  ...
  ssh(master, opts, "rm -rf spark-ec2 && git clone https://github.com/haoyuan/spark-ec2.git -b v2")
